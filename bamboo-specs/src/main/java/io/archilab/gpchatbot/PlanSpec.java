                ...
                .jobs(new Job("Default Job",
                    ...
                    .tasks(new VcsCheckoutTask()
                        ...
                        new DockerPushImageTask()
                            .customRegistryImage("docker.nexus.gpchatbot.archi-lab.io/chatbot/webchat")
                            .defaultAuthentication(),
                        new DockerPushImageTask()
                            .customRegistryImage("docker.nexus.gpchatbot.archi-lab.io/chatbot/webchat:${bamboo.inject.commit-hash}")
                            .defaultAuthentication(),
                        new ScriptTask()
